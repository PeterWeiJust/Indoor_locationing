# -*- coding: utf-8 -*-
"""
Created on Thu Jun  4 23:29:31 2020
...
model_name = "wifiSVM_classification_bucharest_testing"
...
locationtest=locationtest.reshape(-1)
loclatlng=pf.convert_data_to_utm(locpredlabel)
loctestlatlng=pf.convert_data_to_utm(locationtest)
data=pf.normalized_data(np.hstack((loctestlatlng,loclatlng)))
...
#draw cdf picture
fig=plt.figure()
bin_edge,cdf=pf.cdfdiff(target=loctestlatlng,predict=loclatlng)
